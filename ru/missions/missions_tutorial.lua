...
lang["#MISSION_GIVER_STARTER_GREET_FINISHED"] = "Снова здравствуйте, $playername. Если вы ищете, чем заняться, я бы порекомендовал поговорить с Майором Редманом и Мэй Лиан в городе-крепости, зайти в офис НКР в поисках Редмана и поискать Мэй Лиан в центре каравана. Вы можете добраться туда, следуя по дороге в долину."
...
lang["#MISSION_STARTER_MAJORREDMAN_DESC"] = "Ну, мне кажется, что вы знаете достаточно основ. Вы, вероятно, хотите сделать больше, поэтому я предлагаю поговорить с майором Редманом и Мэй Лянь. Они помогут вам выполнить несколько несложных заданий. Сообщите им, что я послал вас."
lang["#MISSION_STARTER_MAJORREDMAN_HINT"] = "Отправляйтесь в город НКР и зайдите в штаб, чтобы поговорить с майором Редманом и Мэй Лянь. В город можно попасть, следуя по главной дороге, а затем пройдя через небольшую долину."
